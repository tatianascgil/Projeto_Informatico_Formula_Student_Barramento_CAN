...
"}"));
        ...
        label_3->setGeometry(QRect(60, 130, 91, 31));
        ...
        labelMarcaCarro->setGeometry(QRect(140, 90, 351, 31));
    ...
    void retranslateUi(QWidget *VerCarro)
    {
        ...
        labelMarcaCarro->setText(QCoreApplication::translate("VerCarro", "Eletrico", nullptr));
